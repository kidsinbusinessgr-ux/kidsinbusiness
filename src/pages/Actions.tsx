...
const VALID_CHAPTER_IDS = ["1", "2", "3", "4", "5"] as const;

const MINI_DURATIONS: string[] = ["5 λεπτά", "10 λεπτά", "15 λεπτά", "30 λεπτά"];
const CLASS_DURATIONS: string[] = ["15 λεπτά", "30 λεπτά", "45 λεπτά"];
const ALL_DURATIONS: string[] = Array.from(new Set([...MINI_DURATIONS, ...CLASS_DURATIONS]));
